package com.testcae.executor;

import com.java.programme.*;
...
public class Runner {
    public static void main(String[] args){
        ...
        vowelChecker.validateVowelCheck('a');*/
        /*DuplicateCharacterCount duplicateCharacterCount = new DuplicateCharacterCount();
        duplicateCharacterCount.duplicateCharCount("ganesh kumar rath");*/
        /*StringToInteger stringToInteger = new StringToInteger();
        stringToInteger.convertStringToInteger("50");
        stringToInteger.convertStringToInteger("50a");
